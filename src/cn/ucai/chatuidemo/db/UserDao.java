...
public class UserDao {
    ...
    public static final String MY_TABLE_NAME = "t_superwechat_contact";
    public static final String MY_COLUMN_NAME_ID = "muserName";
    public static final String MY_COLUMN_NAME_NICK = "muserNick";
    public static final String MY_COLUMN_NAME_AVATAR = "mavatarId";
    public static final String MY_COLUMN_AVATAR_PATH = "mavatarPath";
    public static final String MY_COLUMN_AVATAR_TYPE = "mavatarType";
    public static final String MY_COLUMN_AVATAR_LAST_UPDATA_TIME = "mavatarLastUpdateTime";
    ...
    public void saveUserToHXDB(UserAvatar userAvatar) {
        DemoDBManager.getInstance().savaUserToHXDB(userAvatar);
    }
