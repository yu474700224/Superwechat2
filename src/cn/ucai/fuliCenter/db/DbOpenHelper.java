...
public class DbOpenHelper extends SQLiteOpenHelper{
	...
	private static final String SUPERWECHAT_CREATE_MYTABLE = "CREATE TABLE "
			+ UserDao.MY_TABLE_NAME + " ("
			+ UserDao.MY_COLUMN_NAME_ID + " TEXT PRIMARY KEY, "
			+ UserDao.MY_COLUMN_NAME_NICK + " TEXT, "
			+ UserDao.MY_COLUMN_NAME_AVATAR + " INTEGER, "
			+ UserDao.MY_COLUMN_AVATAR_PATH + " TEXT, "
			+ UserDao.MY_COLUMN_AVATAR_TYPE + " INTEGER, "
			+ UserDao.MY_COLUMN_AVATAR_LAST_UPDATA_TIME + " TEXT); ";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(SUPERWECHAT_CREATE_MYTABLE);
	}
